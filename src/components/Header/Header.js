...
function Header() {
    return (
        <div style={{ background: "rgb(31, 37, 51)", color: "white" }}>
            <Navbar id="navbar" expand="lg" variant="dark">
                <Container>
                    <a href="./image2.png" target="_blank">
                        <img viewBox="0 0 88 26" width="115" src="image2.png" alt="An image"/>
                    </a>
                    ...
                    <Navbar.Collapse id="navbarScroll">
                        <Nav
                            ...
                            navbarScroll
                        >
                            <Nav.Link href="#" target="_blank" id="Home">Home</Nav.Link>
            ...
            <Container style={{ padding: '2px 2px 2px 2px', background: 'rgb(31, 37, 51)' }}>
                <div>
